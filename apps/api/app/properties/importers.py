...
FIELD_ALIASES: dict[str, tuple[str, ...]] = {
    "parcel_id": ("parcel_id", "parcel", "parcel_number", "folio", "folio_id", "strap"),
    "address": ("address", "situs_address", "site_address", "property_address", "situs"),
    "municipality": ("municipality", "city", "town", "jurisdiction"),
    "postal_code": ("postal_code", "zip", "zipcode", "zip_code"),
    "property_use_code": ("property_use_code", "use_code", "land_use_code"),
    "property_use_category": ("property_use_category", "property_type", "use_category", "land_use"),
    "owner_name": ("owner_name", "owner", "owner_of_record", "taxpayer_name"),
    "mailing_address": ("mailing_address", "owner_mailing_address", "tax_mailing_address"),
    "year_built": ("year_built", "built_year"),
    "effective_year_built": ("effective_year_built", "effective_built_year"),
    "building_area": ("building_area", "building_sqft", "gross_building_area", "total_area"),
    "living_area": ("living_area", "living_sqft", "heated_area"),
    "number_of_buildings": ("number_of_buildings", "building_count", "structures"),
    "number_of_units": ("number_of_units", "units", "unit_count"),
