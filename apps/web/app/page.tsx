...
type View = "command" | "stream" | "opportunities" | "workflow" | "analytics" | "health" | "settings";
...
function viewDescription(view: View) { return { command: "Inspect source-preserving incidents and evidence.", stream: "Source-preserving incident updates from approved Sarasota snapshots.", opportunities: "Provisional research ranking, never an empirical probability.", workflow: "Internal alerts, assignments, notes, and suppression controls.", analytics: "Manual labels, funnel outcomes, and reproducible directional metrics.", health: "Freshness, provenance, and integration posture at a glance.", settings: "Governance controls for a deliberately constrained workspace." }[view]; }
