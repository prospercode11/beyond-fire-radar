...
The initial ranking baseline will be evidence-gated and multiplicative in shape so a critically weak dimension cannot be hidden by unrelated strong dimensions. It will be called a provisional ranking/evidence tier, not an empirical probability. Alerts must abstain when critical evidence is missing, the top two property candidates are too close, or contradictions remain unresolved.
